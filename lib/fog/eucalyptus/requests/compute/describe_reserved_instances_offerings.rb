  ...
  module Compute
    class Eucalyptus
      class Real
        ...
        #
        # {Amazon API Reference}[http://docs.amazonwebservices.com/EucalyptusEC2/latest/APIReference/ApiReference-query-DescribeReservedInstancesOfferings.html]
        def describe_reserved_instances_offerings(filters = {})
          params = Fog::Eucalyptus.indexed_filters(filters)
          request({
            'Action'    => 'DescribeReservedInstancesOfferings',
            :idempotent => true,
            :parser     => Fog::Parsers::Compute::Eucalyptus::DescribeReservedInstancesOfferings.new
          }.merge!(params))
        end
      end
      ...
      class Mock
        def describe_reserved_instances_offerings(filters = {})
          ...
          self.data[:reserved_instances_offerings] ||= [{
            'reservedInstancesOfferingId' => Fog::Eucalyptus::Mock.reserved_instances_offering_id,
