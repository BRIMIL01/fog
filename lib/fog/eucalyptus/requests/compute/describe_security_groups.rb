  ...
  module Compute
    class Eucalyptus
      class Real
        ...
        require 'fog/eucalyptus/parsers/compute/describe_security_groups'
        ...
        #         * 'groups'<~Array>:
        #           * 'groupName'<~String> - Name of security group
        #           * 'userId'<~String> - Eucalyptus User Id of account
        #         * 'ipProtocol'<~String> - Ip protocol, must be in ['tcp', 'udp', 'icmp']
        #         * 'ipRanges'<~Array>:
        #           * 'cidrIp'<~String> - CIDR range
        #         * 'toPort'<~Integer> - End of port range (or -1 for ICMP wildcard)
        #       * 'ownerId'<~String> - Eucalyptus Access Key Id of the owner of the security group
        #
        # {Amazon API Reference}[http://docs.amazonwebservices.com/EucalyptusEC2/latest/APIReference/ApiReference-query-DescribeSecurityGroups.html]
        def describe_security_groups(filters = {})
          ...
          request({
            ...
            :idempotent => true,
            :parser     => Fog::Parsers::Compute::Eucalyptus::DescribeSecurityGroups.new
          }.merge!(params))
        end
