  ...
  module Compute
    class Eucalyptus
      class Real
        ...
        #
        # {Amazon API Reference}[http://docs.amazonwebservices.com/EucalyptusEC2/2012-03-01/APIReference/index.html?ApiReference-query-AttachNetworkInterface.html]
        def attach_network_interface(nic_id, instance_id, device_index)
          request(
            ...
            :parser => Fog::Parsers::Compute::Eucalyptus::AttachNetworkInterface.new
          )
        end
      end
      ...
      class Mock
        ...
        def attach_network_interface(nic_id, instance_id, device_index)
          ...
          if self.data[:network_interfaces][nic_id]
            ...
            attachment['attachmentId'] = Fog::Eucalyptus::Mock.request_id
            ...
            raise Fog::Compute::Eucalyptus::NotFound.new("The network interface '#{nic_id}' does not exist")
          end
